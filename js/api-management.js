...
function printRecipes() {
  ...
  for (let i = 0; i < parsed_response['hits'].length; i++){
    ...
    proteins = Math.round(recipe['digest'][2]['total'])
    ...
    $('#recipes-box').append
    (
      '<div class="modal micromodal-slide" id="modal-'+id_counter+'" aria-hidden="true"><div class="modal__overlay" tabindex="-1" data-micromodal-close><div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title"><header class="modal__header"><button class="modal__close" aria-label="Close modal" data-micromodal-close></button></header><main class="modal__content" id="modal-'+id_counter+'-content"><div class="image-title-container"><img class="image" src="'+image+'" alt="'+title+'"><h2 class="title">'+title+'</h3></div><div class="general-info"><h3 class="subtitle">General Information</h2><ul class="general-item"><li class="list-item"><h4 class="list-title">Calories</h4><span class="calories">'+calories+'</span></li><li class="list-item"><h4 class="list-title">Cusine Type</h4><span class="cuisine-type">'+cuisine_type+'</span></li><li class="list-item"><h4 class="list-title">Meal Type</h4><span class="meal-type">'+meal_type+'</span></li><li class="list-item"><h4 class="list-title">Dish Type</h4><span class="dish-type">'+dish_type+'</span></li><li class="list-item"><h4 class="list-title">Serves</h4><span class="serves">'+serves+'</span></li><li class="list-item"><h4 class="list-title">Diet Labels</h4><span class="diet-labels">'+diet_labels+'</span></li></ul></div>'+health_labels+'<div class="nutritional-info"><h3 class="subtitle">Nutritional Information</h3><ul class="nutritional-item proteins"><div class="title-container"><h4 class="list-title">Protein</h4><i class="fas fa-chevron-down icon"></i></div><div class="list-container"><li class="list-item"><span class="left">Total</span><span class="right total">'+proteins+'</span></li></div></ul><ul class="nutritional-item carbs"><div class="title-container"><h4 class="list-title">Carbs</h4><i class="fas fa-chevron-down icon"></i></div><div class="list-container"><li class="list-item"><span class="left">Total</span><span class="right total">'+carbs['total']+'</span></li><li class="list-item"><span class="left">Fiber</span><span class="right fiber">'+carbs['Fiber']+'</span></li><li class="list-item"><span class="left">Sugars</span><span class="right sugar">'+carbs['Sugars']+'</span></li><li class="list-item"><span class="left">Sugars Added</span><span class="right sugar-added">'+carbs['Sugars, added']+'</span></li></div></ul><ul class="nutritional-item fat"><div class="title-container"><h4 class="list-title">Fats</h4><i class="fas fa-chevron-down icon"></i></div><div class="list-container"><li class="list-item"><span class="left">Total</span><span class="right total">'+fat['total']+'</span></li><li class="list-item"><span class="left">Trans</span><span class="right trans">'+fat['Trans']+'</span></li><li class="list-item"><span class="left">Saturated</span><span class="right saturated">'+fat['Saturated']+'</span></li><li class="list-item"><span class="left">Monounsaturated</span><span class="right monounsaturated">'+fat['Monounsaturated']+'</span></li><li class="list-item"><span class="left">Polyunsaturated</span><span class="right polyunsaturated">'+fat['Polyunsaturated']+'</span></li></div></ul><ul class="nutritional-item vitamins"><div class="title-container"><h4 class="list-title">Vitamins</h4><i class="fas fa-chevron-down icon"></i></div><div class="list-container"><li class="list-item"><span class="left">A</span><span class="right">'+vitamins['A']+'</span></li><li class="list-item"><span class="left">C</span><span class="right">'+vitamins['C']+'</span></li><li class="list-item"><span class="left">B1</span><span class="right">'+vitamins['B1']+'</span></li><li class="list-item"><span class="left">B2</span><span class="right">'+vitamins['B2']+'</span></li><li class="list-item"><span class="left">B3</span><span class="right">'+vitamins['B3']+'</span></li><li class="list-item"><span class="left">B6</span><span class="right">'+vitamins['B6']+'</span></li><li class="list-item"><span class="left">B9</span><span class="right">'+vitamins['B9']+'</span></li><li class="list-item"><span class="left">B12</span><span class="right">'+vitamins['B12']+'</span></li><li class="list-item"><span class="left">D</span><span class="right">'+vitamins['D']+'</span></li><li class="list-item"><span class="left">E</span><span class="right">'+vitamins['E']+'</span></li><li class="list-item"><span class="left">K</span><span class="right">'+vitamins['K']+'</span></li></div></ul><ul class="nutritional-item minerals"><div class="title-container"><h4 class="list-title">Minerals</h4><i class="fas fa-chevron-down icon"></i></div><div class="list-container"><li class="list-item"><span class="left">Sodium</span><span class="right">'+minerals['Sodium']+'</span></li><li class="list-item"><span class="left">Calcium</span><span class="right">'+minerals['Calcium']+'</span></li><li class="list-item"><span class="left">Magnesium</span><span class="right">'+minerals['Magnesium']+'</span></li><li class="list-item"><span class="left">Potassium</span><span class="right">'+minerals['Potassium']+'</span></li><li class="list-item"><span class="left">Iron</span><span class="right">'+minerals['Iron']+'</span></li><li class="list-item"><span class="left">Zinc</span><span class="right">'+minerals['Zinc']+'</span></li><li class="list-item"><span class="left">Phosphorus</span><span class="right">'+minerals['Phosphorus']+'</span></li></div></ul></div></main></div></div></div>'
      )
id_counter++
}
manageBoxesStyle()
...
function getHealthLabelsHtml(nutrient_object) {
  ...
  for(let i = 0; i < nutrient_object.length; i++) {
    added_html += '<li class="list-item"><span class="health-label">'+nutrient_object[i]+'</span></li>'
  }
  added_html += '</ul></div>'
